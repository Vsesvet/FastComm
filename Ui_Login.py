...
class Ui_Login(object):
    ...
    def retranslateUi(self, Login):
        ...
        Login.setWindowTitle(_translate("Login", "Fast Community  (update 07.06.23)"))
        ...
        self.label_bad_password.setText(_translate("Login", "не верный"))
        self.lineEdit_login.setPlaceholderText(_translate("Login", "89265002010"))
        self.label_login.setText(_translate("Login", "Логин"))
        self.label_user_not_found.setText(_translate("Login", "не найден"))
