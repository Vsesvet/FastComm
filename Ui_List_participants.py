...
class Ui_List_participants(object):
    def setupUi(self, List_participants):
        ...
        List_participants.setTabOrder(self.lineEdit_find_by_phone, self.pushButton_find)
        List_participants.setTabOrder(self.pushButton_find, self.pushButton_export_xls)
