...
class Ui_Event_shedule(object):
    def setupUi(self, Event_shedule):
        ...
        self.gridLayout_2.addWidget(self.pushButton_list_of_all_participants, 3, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_total_completed_events, 5, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.dateEdit_begin_event, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.dateEdit_finish_event, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_find_event, 0, 0, 1, 1)
        self.gridLayout_2.addLayout(self.gridLayout, 7, 0, 1, 8)
        ...
        self.tree_event_shedule.headerItem().setText(2, "date_time_start")
        ...
        self.gridLayout_2.addWidget(self.tree_event_shedule, 4, 0, 1, 8)
        ...
        self.gridLayout_2.addWidget(self.label_find_event, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_list_organization, 3, 6, 1, 1)
        self.pushButton_print = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_print.setObjectName("pushButton_print")
        self.gridLayout_2.addWidget(self.pushButton_print, 2, 6, 1, 1)
        self.pushButton_reset_find = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_reset_find.setObjectName("pushButton_reset_find")
        self.gridLayout_2.addWidget(self.pushButton_reset_find, 6, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_exit, 2, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_event_shedule, 1, 0, 1, 8)
        ...
        self.gridLayout_2.addWidget(self.pushButton_export_xls, 2, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_username_login_role, 0, 5, 1, 3)
        ...
        Event_shedule.setTabOrder(self.tree_event_shedule, self.lineEdit_find_event)
        ...
        Event_shedule.setTabOrder(self.comboBox_event_status, self.pushButton_export_xls)
        Event_shedule.setTabOrder(self.pushButton_export_xls, self.pushButton_print)
        Event_shedule.setTabOrder(self.pushButton_print, self.pushButton_list_organization)
        Event_shedule.setTabOrder(self.pushButton_list_organization, self.pushButton_exit)
        Event_shedule.setTabOrder(self.pushButton_exit, self.pushButton_list_of_all_participants)
    ...
    def retranslateUi(self, Event_shedule):
        ...
        self.comboBox_event_status.setItemText(2, _translate("Event_shedule", "В работе"))
        self.comboBox_event_status.setItemText(3, _translate("Event_shedule", "Проведено"))
        self.comboBox_event_status.setItemText(4, _translate("Event_shedule", "Отменено"))
        ...
        self.pushButton_reset_find.setText(_translate("Event_shedule", "Сброс всех фильтров"))
