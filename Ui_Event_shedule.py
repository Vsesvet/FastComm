...
class Ui_Event_shedule(object):
    def setupUi(self, Event_shedule):
        ...
        self.gridLayout.addWidget(self.dateEdit_begin_event, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.dateEdit_finish_event, 0, 3, 1, 1)
        ...
        self.comboBox_event_status.addItem("")
        self.comboBox_event_status.addItem("")
        self.gridLayout.addWidget(self.comboBox_event_status, 0, 6, 1, 1)
        self.label_status_event = QtWidgets.QLabel(self.centralwidget)
        self.label_status_event.setObjectName("label_status_event")
        self.gridLayout.addWidget(self.label_status_event, 0, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_reset_find, 6, 2, 1, 1)
