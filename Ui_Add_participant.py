...
class Ui_Add_participant(object):
    def setupUi(self, Add_participant):
        ...
        self.lineEdit_email_participant = QtWidgets.QLineEdit(Add_participant)
        self.lineEdit_email_participant.setObjectName("lineEdit_email_participant")
        self.gridLayout.addWidget(self.lineEdit_email_participant, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_find_participant, 2, 3, 1, 1)
    ...
    def retranslateUi(self, Add_participant):
        ...
        self.lineEdit_email_participant.setPlaceholderText(_translate("Add_participant", "e-mail..."))
